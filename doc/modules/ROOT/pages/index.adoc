...
printing Kerberos related debug messages to console. Just edit the Hazelcast
...
We will also need the new `debug-logging.properties` file beside the batch file:
